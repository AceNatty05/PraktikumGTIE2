...
enum GameOverReason { REASON_GAS, REASON_ROCK };
GameOverReason gameOverReason = REASON_GAS;
...
void drawTreePine(float x, float z, float sc) {
    ...
    for (int i = 0; i < 3; i++) {
        glPushMatrix();
		glTranslatef(0, 1.0f + i * 0.55f, 0);
		glRotatef(-90, 1, 0, 0);
		glutSolidCone(1.0f - i * 0.25f, 0.85f, 10, 10);
		glPopMatrix();
    }
    glPopMatrix();
}
...
void drawTreePalm(float x, float z, float sc) {
	...
	glRotatef(-90, 1, 0, 0);
	drawCylinder(0.07f, 0.45f, 8, 4);
	glPopMatrix();
	
    glColor3f(0.14f, 0.58f, 0.14f);
    for (int i = 0; i < 7; i++) {
        float t = (float)i / 6.0f; float r = 0.52f * (1.0f - t * 0.72f);
		float yOff = 0.80f + t * 2.05f;
        glPushMatrix();
...
void drawTreeBranchy(float x, float z, float sc) {
    ...
    for (int i = 0; i < 4; i++) {
        glPushMatrix();
		glTranslatef(off[i][0] * 0.6f, 2.3f, off[i][1] * 0.6f);
...
void drawBuildingSetback(float x, float z) {
	...
	glScalef(9.0f, 6.0f, 7.0f);
	glutSolidCube(1.0f);
	glPopMatrix();
	
    glPushMatrix();
	glTranslatef(0.0f, 7.625f, 0.0f);
	glScalef(7.0f, 5.0f, 5.5f);
	glutSolidCube(1.0f);
	glPopMatrix();
	
    glPushMatrix();
	glTranslatef(0.0f, 11.625f, 0.0f);
	glScalef(4.5f, 4.0f, 4.0f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPopMatrix();
}
...
void drawBuildingGlass(float x, float z) {
    ...
    glPushMatrix();
	glTranslatef(0.0f, h + 0.2f, 0.0f);
	glScalef(w + 0.6f, 0.4f, d + 0.6f);
	glutSolidCube(1.0f); 
	glPopMatrix();
    glPopMatrix();
}
...
void drawBuildingWarehouse(float x, float z) {
    ...
    glPushMatrix();
	glTranslatef(0.0f, 6.425f, 0.0f);
	glScalef(9.0f, 0.6f, 8.3f);
	glutSolidCube(1.0f);
	glPopMatrix();
	
    glColor3f(0.95f, 0.65f, 0.25f);
    glPushMatrix();
	glTranslatef(0.0f, 1.225f, 3.77f);
	glScalef(2.2f, 3.2f, 0.05f);
	glutSolidCube(1.0f);
	glPopMatrix();
	
    glColor3f(0.55f, 0.35f, 0.25f);
    glPushMatrix();
	glTranslatef(2.5f, 7.875f, -2.0f);
...
void drawBuildingTower(float x, float z) {
	...
	glScalef(5.2f, 0.4f, 5.2f);
	glutSolidCube(1.0f);
	glPopMatrix();
	
    glPushMatrix();
	glTranslatef(0.0f, 9.125f, 0.0f);
	glScalef(5.2f, 0.4f, 5.2f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPushMatrix();
    
	glTranslatef(0.0f, 14.125f, 0.0f);
	glScalef(5.2f, 0.4f, 5.2f);
	glutSolidCube(1.0f);
	glPopMatrix();
    ...
    glPushMatrix();
	glTranslatef(0.0f, 16.025f, 0.0f);
	glScalef(4.0f, 0.6f, 4.0f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPushMatrix();
    
	glTranslatef(0.0f, 16.625f, 0.0f);
	glScalef(3.0f, 0.6f, 3.0f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPushMatrix();
    
	glTranslatef(0.0f, 17.225f, 0.0f);
	glScalef(2.0f, 0.6f, 2.0f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPushMatrix();
	glTranslatef(0.0f, 18.225f, 0.0f);
...
void drawJerrycan(float x, float z, float bobY) {
	...
	glRotatef(90, 1, 0, 0);
	drawCylinder(0.025f, 0.14f, 6, 3);
	glPopMatrix();

    glColor3f(0.95f, 0.80f, 0.05f); 
    glPushMatrix();
	glTranslatef(0, 0, 0.11f);
	glScalef(0.28f, 0.08f, 0.01f);
	glutSolidCube(1.0f);
	glPopMatrix();
...
void drawRock(float x, float z) {
	...
	glScalef(1.6f, 1.1f, 1.3f);
	glutSolidSphere(0.9f, 12, 10);
	glPopMatrix();
	
    glColor3f(0.44f, 0.41f, 0.38f);
    glPushMatrix();
	glTranslatef(-0.55f, 1.4f, 0.2f);
    ...
    glPushMatrix();
	glTranslatef(0.6f, 0.5f, -0.3f);
	glScalef(0.9f, 0.6f, 0.7f);
	glutSolidSphere(0.55f, 10, 8);
	glPopMatrix();
	
    glColor3f(0.38f, 0.36f, 0.33f);
    glPushMatrix();
	glTranslatef(0.0f, 0.18f, 0.0f);
	glScalef(1.8f, 0.35f, 1.5f);
	glutSolidSphere(0.7f, 10, 6);
	glPopMatrix();
    glPopMatrix();
}
...
static float objectRadius(const WorldObject& o) {
    if (o.type < 5)  return 3.5f;
    if (o.type == 10) return 2.0f;
    return 6.0f;
}
    ...
    for (int t = 0; t < 3; t++) {
        ...
        }
        {
            ...
            if (canPlace(13.5f, tz2, 3.5f)) {
                WorldObject or2;
				or2.type = tt; or2.x = 13.5f; or2.z = tz2;
				or2.scale = sc;
...
void drawSkybox() {
	...
	glVertex3f(-size, y_low, -size);
    glTexCoord2f(1.0f + texOffset, 0.0f);
	glVertex3f( size, y_low, -size);
    glTexCoord2f(1.0f + texOffset, 1.0f);
	glVertex3f( size, y_high, -size);
    glTexCoord2f(0.0f + texOffset, 1.0f);
	glVertex3f(-size, y_high, -size);
    glTexCoord2f(0.0f - texOffset, 0.0f);
	glVertex3f( size, y_low,  size);
    glTexCoord2f(1.0f - texOffset, 0.0f);
    ...
    glTexCoord2f(0.0f - texOffset, 1.0f);
	glVertex3f( size, y_high, -size);
    glTexCoord2f(0.0f, 0.0f + texOffset);
	glVertex3f(-size, y_high, -size);
    glTexCoord2f(1.0f, 0.0f + texOffset);
	glVertex3f( size, y_high, -size);
    glTexCoord2f(1.0f, 1.0f + texOffset);
	glVertex3f( size, y_high,  size);
    glTexCoord2f(0.0f, 1.0f + texOffset);
	glVertex3f(-size, y_high,  size);
    glEnd();
    glPopMatrix();
    glDepthMask(GL_TRUE);
...
void drawGround1() {
    ...
    if (asphaltTexID != 0) {
        ...
        glTexCoord2f(0.0f, texZStart);
		glVertex3f(-roadW, 0.02f, zStart); 
        glTexCoord2f(1.0f, texZStart);
		glVertex3f( roadW, 0.02f, zStart);
        glTexCoord2f(1.0f, texZEnd);
		glVertex3f( roadW, 0.02f, zEnd);   
        glTexCoord2f(0.0f, texZEnd);
		glVertex3f(-roadW, 0.02f, zEnd);
    } else {
        glVertex3f(-roadW, 0.02f, zStart); 
        glVertex3f( roadW, 0.02f, zStart);
    ...
    for (int i = startMark; i <= endMark; i++) {
        glPushMatrix();
		glTranslatef(-2.5f, 0.03f, i * 6.0f);
		glScalef(0.12f, 0.01f, 3.0f);
		glutSolidCube(1);
		glPopMatrix();
...
void drawGround2() {
    ...
    if (grassTexID != 0) {
        ...
        glTexCoord2f(0.0f, texZStart);
		glVertex3f(-outerEdge, 0, zStart);
        glTexCoord2f(texLen / 4.0f, texZStart);
		glVertex3f(-innerEdge, 0, zStart);
        glTexCoord2f(texLen / 4.0f, texZEnd);
		glVertex3f(-innerEdge, 0, zEnd);
        glTexCoord2f(0.0f, texZEnd);
		glVertex3f(-outerEdge, 0, zEnd);
...
void drawTreeBackdrop() {
    ...
    glTexCoord2f(texZStart, 1.0f);
	glVertex3f(-outerEdge, -0.375f, zStart);
    glTexCoord2f(texZEnd,   1.0f);
	glVertex3f(-outerEdge, -0.375f, zEnd);
    glTexCoord2f(texZEnd,   0.0f);
	glVertex3f(-outerEdge, wallHeight, zEnd);
    glTexCoord2f(texZStart, 0.0f);
	glVertex3f(-outerEdge, wallHeight, zStart);
    ...
    glTexCoord2f(texZStart, 1.0f);
	glVertex3f(-frontEdge, -0.375f + frontHeightOffset, zStart);
	glTexCoord2f(texZEnd, 1.0f); 
	glVertex3f(-frontEdge, -0.375f + frontHeightOffset, zEnd);
    glTexCoord2f(texZEnd, 0.0f);
	glVertex3f(-frontEdge, wallHeight + frontHeightOffset, zEnd);
    glTexCoord2f(texZStart, 0.0f);
	glVertex3f(-frontEdge, wallHeight + frontHeightOffset, zStart);
...
void drawFinishLine() {
    ...
    for (int i = 0; i < tiles; i++) {
        bool white = (i % 2 == 0);
		glColor3f(white ? 1.0f : 0.0f, white ? 1.0f : 0.0f, white ? 1.0f : 0.0f);
        glPushMatrix();
		glTranslatef(-7.5f + tw * (i + 0.5f), -0.29f, fz);
		glScalef(tw, 0.02f, 1.5f);
		glutSolidCube(1);
		glPopMatrix();
    }
	...
	glPushMatrix();
	  glTranslatef(tiang[t][0], 3.0f, fz);
    ...
    for (int seg = 0; seg < 20; seg++) {
        ...
        glPushMatrix();
		glTranslatef(sx + 0.375f, 6.1f, fz);
		glScalef(0.75f, 0.4f, 0.15f);
		glutSolidCube(1);
		glPopMatrix();
    }
    glColor3f(0.9f, 0.85f, 0.1f);
    glPushMatrix();
	glTranslatef(0, 5.85f, fz);
	glScalef(15.4f, 0.12f, 0.18f);
	glutSolidCube(1);
	glPopMatrix();
    glPushMatrix();
    
	glTranslatef(0, 6.4f, fz);
	glScalef(15.4f, 0.12f, 0.18f);
	glutSolidCube(1);
	glPopMatrix();
}
...
void drawWheel(float x, float y, float z) {
	...
	glRotatef(90, 0, 1, 0);
    glColor3f(0.1f, 0.1f, 0.1f);
	glutSolidTorus(0.12f, 0.28f, 16, 16);
...
void drawCar() {
	...
	glScalef(1.5f, 0.5f, 3.5f);
	glutSolidCube(1.0f);
	glPopMatrix();
	
    glPushMatrix();
	glTranslatef(0.0f, 0.75f, -0.2f);
	glScalef(1.3f, 0.45f, 1.8f);
	glutSolidCube(1.0f);
	glPopMatrix();
	...
	glTranslatef(0.0f, 0.75f, -0.2f);
	glScalef(1.32f, 0.35f, 1.6f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPushMatrix();
    
	glTranslatef(0.0f, 0.75f, 0.68f);
	glScalef(1.2f, 0.35f, 0.05f);
	glutSolidCube(1.0f);
	glPopMatrix();
    glPushMatrix();
	glTranslatef(0.0f, 0.75f, -1.08f);
	glScalef(1.2f, 0.35f, 0.05f);
	glutSolidCube(1.0f);
	glPopMatrix();
    ...
    for (int i = 0; i < 2; i++) {
        glPushMatrix();
		glTranslatef(lp[i], 0.4f, -1.76f);
		glScalef(0.35f, 0.22f, 0.05f);
		glutSolidCube(1.0f);
		glPopMatrix();
    }
    glColor3f(0.15f, 0.15f, 0.15f);
    glPushMatrix();
	glTranslatef(0.0f, 0.15f, 1.76f);
	glScalef(1.52f, 0.2f, 0.1f);
	glutSolidCube(1.0f);
	glPopMatrix();
...
void drawHUD() {
    ...
    float bx = 20, by = 20, bw = 250, bh = 65;
    ...
    glColor3f(gr < 0 ? 0 : gr, gg > 1 ? 1 : gg, 0);
	glBegin(GL_QUADS);
	glVertex2f(barX, barY);
	glVertex2f(barX + barW * ratio, barY);
	glVertex2f(barX + barW * ratio, barY + barH);
	glVertex2f(barX, barY + barH);
	glEnd();
	
    char buf[64]; snprintf(buf, sizeof(buf), "%.0f%%", gas);
	glColor3f(1, 1, 1);
	drawString2D(barX + barW + 5, barY, buf);
    if (currentState == GAME_OVER && gas <= 0) { 
	glColor3f(1.0f, 0.25f, 0.25f);
	 drawString2D(bx + 8, by + 14, "Kehabisan Gas!"); }
    else { 
		snprintf(buf, sizeof(buf), "Speed: %.1f", carSpeed * 200.0f);
		glColor3f(0.75f, 0.75f, 0.75f);
		drawString2D(bx + 8, by + 14, buf);
		}
...
if (currentState == GAME_OVER) {
        ...
        const char* tFuel = (gameOverReason == REASON_ROCK) ? "You hit a rock!" : "You ran out of fuel!";
...
void reshape(int w, int h) {
    ...
    glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
	gluPerspective(55, (float)w / h, 0.3f, 600);
	glMatrixMode(GL_MODELVIEW);
}
...
void setup() {
    ...
    glEnable(GL_BLEND);
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
	glClearColor(0.4f, 0.72f, 1.0f, 1.0f);
    GLfloat lpos[] = { 10, 15, 10, 0 };
	glLightfv(GL_LIGHT0, GL_POSITION, lpos);
    GLfloat amb[] = { 0.38f, 0.38f, 0.38f, 1 };
